...
import android.me.keenanstory.databinding.ActivityItemStoriesBinding
import android.me.keenanstory.DetailActivity
import android.me.keenanstory.withDateFormat
    ...
    class ListViewHolder(private var itemstoriesbunching: ActivityItemStoriesBinding) : RecyclerView.ViewHolder(itemstoriesbunching.root) {
        fun bind(table: TabStoriesItem) {
            ...
            itemView.setOnClickListener {
                ...
                intent.putExtra(DetailActivity.EXTRA_STORY, table)
