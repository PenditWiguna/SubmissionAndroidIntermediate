...
import android.me.keenanstory.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.myCaptureImage.setOnClickListener { takePhoto() }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(binding.myViewFinder.surfaceProvider)
                }
